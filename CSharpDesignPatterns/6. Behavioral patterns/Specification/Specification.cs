namespace CSharpDesignPatterns._6._Behavioral_patterns.Specification
{
    ...
    public class IntLessThan : LinqSpecification<int>
    {
        private readonly int cutoff;

        public IntLessThan(int cutoff)
        ...
        {
            return movie => movie <= this.cutoff;
        }
    }

    public class IntGreaterThan : LinqSpecification<int>
    {
        private readonly int cutoff;

        public IntGreaterThan(int cutoff)
        {
            this.cutoff = cutoff;
        }
